...
intermediates := $(shell realpath obj)
...
PF_EXT_SLIB+=SAME SNAT ULOG  statistic standard # TOS TCPMSS TTL
...
$(GEN_INITEXT):
	mkdir -p $(intermediates)/extensions/
	echo
	echo EXT_FUNC
	echo $(EXT_FUNC)
	echo
	echo PF_EXT_SLIB
	echo $(PF_EXT_SLIB)
	$(PRIVATE_PATH)/extensions/create_initext "$(EXT_FUNC)" > $@
